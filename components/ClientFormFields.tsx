  ...
  return <>
    <details className="form-section full income-form-section supplier-form-section" open>
      ...
      <div className="form-section-grid income-form-section-grid supplier-form-section-grid">
        <label className="span-2">Ragione sociale<input name="businessName" required defaultValue={customer?.businessName ?? ''} /></label>
        <label>Referente<input name="alias" defaultValue={customer?.alias ?? ''} /></label>
        <label>Email<input type="email" name="email" defaultValue={customer?.email ?? ''} /></label>
        <label>P.IVA / C.F.<input name="vatNumber" defaultValue={customer?.vatNumber ?? ''} /></label>
        <label>Cod. SDI<input name="taxCodeSdi" defaultValue={customer?.taxCodeSdi ?? ''} /></label>

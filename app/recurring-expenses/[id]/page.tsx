...
export default async function RecurringExpenseDetailPage({params, searchParams}: {
    ...
    return <RecurringStateProvider><div className="grid record-detail-page recurring-record-detail-page">
        ...
        <div className="record-detail-shell">
            <div className="record-detail-action-row hidden-sm-up">
                    ...
                    <RecurringDetailActionsMenu>
                        ...
                        <div className="recurring-detail-actions-panel">
                            ...
                            <DeleteActionButton
                                ...
                                className="btn btn-sm btn-danger"><span className="btn-icon">🗑</span> Elimina
                            </DeleteActionButton>
                        </div>
                    </RecurringDetailActionsMenu>
                    <div className="recurring-detail-actions-inline">
                            <button className="btn btn-sm btn-default" type="button" data-recurring-expense-detail-edit-id={item.id}>
                                <span className="btn-icon">✎</span> Modifica
                            </button>
                            <DeleteActionButton
                                action={`/api/recurring-expenses/${item.id}?returnTo=${encodeURIComponent(returnTo)}`}
                ...
                <section className="record-detail-section">
                    ...
                    <div className="record-detail-status-strip">
                        ...
                        <div>
                            ...
                            <strong>{item.supplierId ?
                                <Link href={`/suppliers/${item.supplierId}?returnTo=${encodedCurrentDetailReturnTo}`}>{merchant}</Link> : merchant}</strong>
                        </div>
                        <div>
                            <span>Categoria</span>

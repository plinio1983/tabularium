  ...
  return <div className="grid employees-page">
    ...
    <div className="card record-list-card">
      ...
      <form id="employeeBulkForm" action={`/api/employees/bulk?returnTo=${encodeURIComponent(returnTo)}`} method="post" className="bulk-actions-bar grouped-bulk-actions-bar party-bulk-actions-bar confirm-bulk-form" data-bulk-button-group="true">
        ...
        <div className="bulk-inner-container"><button className="bulk-direct-link btn btn-md bulk-add-link btn-primary" type="button" data-bulk-new data-employee-new data-floating-label="Dipendente"><span className="btn-icon">＋</span><span className="hidden-sm-down">Dipendente</span></button>

...
export default async function SettingsPage() {
  ...
  return <div className="grid admin-page settings-hub-page">
    ...
    <nav className="settings-category-hub settings-main-hub" aria-label="Sezioni impostazioni">
      {settingsSections.map(section => <Link className="card settings-category-link" href={section.href} key={section.href}>

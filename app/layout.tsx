...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/icons/icon-192.png?v=20260824', sizes: '192x192', type: 'image/png' },
      { url: '/icons/icon-512.png?v=20260824', sizes: '512x512', type: 'image/png' }
    ],
    apple: [{ url: '/icons/apple-touch-icon.png?v=20260824', sizes: '180x180', type: 'image/png' }]
  }
};

    ...
    const mobileSortedSupplierRows = [...filteredSupplierRows].sort((a, b) => {
        switch (mobileSort) {
            case 'businessName_desc':
                return compareText(a.supplier.businessName, b.supplier.businessName, 'desc');
            case 'alias_asc':
                return compareText(a.supplier.alias, b.supplier.alias, 'asc');
            case 'alias_desc':
                return compareText(a.supplier.alias, b.supplier.alias, 'desc');
            case 'email_asc':
                return compareText(a.supplier.email, b.supplier.email, 'asc');
            case 'vatNumber_asc':
                return compareText(a.supplier.vatNumber, b.supplier.vatNumber, 'asc');
            case 'iban_asc':
                return compareText(a.supplier.iban, b.supplier.iban, 'asc');
            case 'pec_asc':
                return compareText(a.supplier.pec, b.supplier.pec, 'asc');
            case 'taxCodeSdi_asc':
                return compareText(a.supplier.taxCodeSdi, b.supplier.taxCodeSdi, 'asc');
            case 'internalNotes_asc':
                return compareText(a.supplier.internalNotes, b.supplier.internalNotes, 'asc');
            case 'openExpensesCount_desc':
                return compareNumber(a.openExpensesCount, b.openExpensesCount, 'desc');
            case 'openExpensesCount_asc':
                return compareNumber(a.openExpensesCount, b.openExpensesCount, 'asc');
            case 'amountToPay_desc':
                return compareNumber(a.amountToPay, b.amountToPay, 'desc');
            case 'amountToPay_asc':
                return compareNumber(a.amountToPay, b.amountToPay, 'asc');
            case 'annualOrdersCount_desc':
                return compareNumber(a.annualOrdersCount, b.annualOrdersCount, 'desc');
            case 'annualOrdersCount_asc':
                return compareNumber(a.annualOrdersCount, b.annualOrdersCount, 'asc');
            case 'annualPurchasedAmount_desc':
                return compareNumber(a.annualPurchasedAmount, b.annualPurchasedAmount, 'desc');
            case 'annualPurchasedAmount_asc':
                return compareNumber(a.annualPurchasedAmount, b.annualPurchasedAmount, 'asc');
            case 'createdAt_desc':
                return compareDate(a.supplier.createdAt, b.supplier.createdAt, 'desc');
            case 'updatedAt_desc':
                return compareDate(a.supplier.updatedAt, b.supplier.updatedAt, 'desc');
            case 'id_desc':
                return compareNumber(a.supplier.id, b.supplier.id, 'desc');
            case 'id_asc':
                return compareNumber(a.supplier.id, b.supplier.id, 'asc');
            default:
                return compareText(a.supplier.businessName, b.supplier.businessName, 'asc');
        }
    });

    const activeFilterItems = [
        inputDefault(filters, 'businessName') && {
            ...
            <form id="supplierBulkForm" action={`/api/suppliers/bulk?returnTo=${returnTo}`} method="post" className="bulk-actions-bar confirm-bulk-form">
              ...
              <span className="floating-bulk-label">Bulk </span>Actions
                    ...
                    <div className="bulk-action-menu-panel">
                        ...
                        <button className="btn btn-sm btn-danger" type="submit" name="bulkAction" value="delete">
                            <span className="btn-icon">🗑</span><span className="bulk-label">Elimina selezionati</span>
                        </button>
                    </div>
                </details>
            ...
            <div className="table-scroll">
                <table className="suppliers-table compact-suppliers-table" data-sortable-table data-default-sort="business-name" data-default-sort-dir="asc">
                    ...
                    <tr>
                        ...
                        <th className="text-right" data-sort-key="annual-amount" data-sort-type="number">Acquisti <br/>anno
                        </th>
                    </tr>
                    </thead>
                    <tbody>
                    {filteredSupplierRows.map(({
                                                   supplier,
                                                   openExpensesCount,
                                                   amountToPay,
                                                   annualOrdersCount,
                    ...
                    {!filteredSupplierRows.length && <tr>
